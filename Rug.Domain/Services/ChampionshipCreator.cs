...
namespace Rug.Domain.Services
{
    ...
    {
        public static ICollection<Match.Match> CreateMatches(Draw draw)
        {
            ...
            {
                if(draw.Teams[pairings[matchPair, 0]] != Team.Team.Default && 
                   draw.Teams[pairings[matchPair, 1]] != Team.Team.Default)
                {
                    matches.Add(
                        new Match.Match(
        ...
        private static class BergerPairings
        {
            ...
            private static readonly byte[,] _3or4TeamsPairings =
            {
                {1,4}, {2,3},
                {4,3}, {1,2},
                {2,4}, {3,1}
            ...
            private static readonly byte[,] _5or6TeamsPairings =
            {
                {1,6}, {2,5}, {3,4},
                {6,4}, {5,3}, {1,2},
                {2,6}, {3,1}, {4,5},
            ...
            private static readonly byte[,] _7or8TeamsPairings =
            {
                {1,8}, {2,7}, {3,6}, {4,5},
                {8,5}, {6,4}, {7,3}, {1,2},
                {2,8}, {3,1}, {4,7}, {5,6},
            ...
            private static readonly byte[,] _9or10TeamsPairings =
            {
            ...
            private static readonly byte[,] _11or12TeamsPairings =
            {
            ...
            private static readonly byte[,] _13or14TeamsPairings =
            {
            ...
            private static readonly byte[,] _15or16TeamsPairings =
            {
            ...
            private static readonly byte[,] _17or18TeamsPairings =
            {
            ...
            private static readonly byte[,] _19or20TeamsPairings =
            {
            ...
            private static readonly byte[,] _21or22TeamsPairings =
            {
